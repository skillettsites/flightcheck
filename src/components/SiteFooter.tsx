...
export default function SiteFooter() {
  ...
  return (
    <footer style={{ borderTop: "1px solid var(--line)", marginTop: 72, padding: "36px 0 40px", background: "var(--paper-2)" }}>
      <div className="wrap foot">
        <div className="small" style={{ maxWidth: 560 }}>
          <p style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: 18, color: "var(--ink)", marginBottom: 10 }}>FlightDelayCheck</p>
      ...
      <div className="wrap" style={{ marginTop: 26, paddingTop: 14, borderTop: "1px solid var(--line)", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
        <p className="small muted" style={{ margin: 0 }}>© {year} FlightDelayCheck · England</p>
        <p className="small muted" style={{ margin: 0 }}><Link href="/terms" style={{ textDecoration: "none" }}>Terms</Link> · <Link href="/privacy" style={{ textDecoration: "none" }}>Privacy</Link> · <Link href="/refunds" style={{ textDecoration: "none" }}>Refunds</Link></p>
      </div>
      <style>{`
