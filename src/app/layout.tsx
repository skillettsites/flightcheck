...
export const metadata: Metadata = {
  ...
  description: "Check a delayed or cancelled flight against the official flight record, the airport delay data and the weather that day. Free verdict in seconds, then a ready-to-send UK261/EU261 claim letter for £4.99.",
